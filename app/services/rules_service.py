...
from app.services.variables.AVG_POINTS_GAME_BY_USER import \
    AveragePointsGameService
from app.services.variables.AVG_POINTS_TASK_BY_USER import \
    AveragePointsTaskService
from app.services.variables.LAST_PERSONAL_POINTS_GAME import \
    LastPersonalPointsGameService
from app.services.variables.LAST_PERSONAL_POINTS_TASK import \
    LastPersonalPointsTaskService
...
class RulesService:
    def __init__(self, db):
        ...
        self.last_personal_points_game_service = LastPersonalPointsGameService(
            ...
            self.game_params_repository,
            self.user_points_repository,
        )
