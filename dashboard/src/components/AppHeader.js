        ...
        <CHeaderNav className="ms-auto">
          ...
          <CDropdown variant="nav-item" placement="bottom-end">
            ...
            <CDropdownMenu>
              ...
              >
                <CIcon className="me-2" icon={cilSun} size="lg" /> {t('header.themeLight')}
              </CDropdownItem>
              <CDropdownItem
              ...
              >
                <CIcon className="me-2" icon={cilMoon} size="lg" /> {t('header.themeDark')}
              </CDropdownItem>
              <CDropdownItem
              ...
              >
                <CIcon className="me-2" icon={cilContrast} size="lg" /> {t('header.themeAuto')}
              </CDropdownItem>
            </CDropdownMenu>
          </CDropdown>
          <li className="nav-item py-1">
