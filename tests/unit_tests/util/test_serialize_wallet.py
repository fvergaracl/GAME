...
class TestSerializeWallet(unittest.TestCase):
    ...
    def test_serialize_uuid(self):
        ...
        """
        wallet = Wallet(id=uuid4(), name="My Wallet",
                        created_at=datetime.now(), balance=100.0)
    ...
    def test_internal_fields_are_ignored(self):
        ...
        """
        wallet = Wallet(id=uuid4(), name="My Wallet", created_at=datetime.now(
        ), balance=100.0, _internal_value="should be ignored")
        serialized = serialize_wallet(wallet)
