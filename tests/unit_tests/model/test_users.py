...
def test_users_creation_and_representation():
    ...
    user = Users(created_at=now, updated_at=now, externalUserId=external_user_id)

    expected_str = f"User: (id:{user.id}, created_at:{now}, updated_at:{now}, externalUserId:{external_user_id})"
...
def test_users_equality():
    ...
    user1 = Users(externalUserId=external_user_id1)
    user2 = Users(externalUserId=external_user_id1)
    user3 = Users(externalUserId=external_user_id2)
...
def test_users_hash():
    ...
    user1 = Users(externalUserId=external_user_id)

    user2 = Users(externalUserId=external_user_id)
