...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("avgInteractionsPerUser", sa.Integer(), nullable=True),
    ...
    op.create_index(op.f("ix_kpimetrics_id"), "kpimetrics", ["id"], unique=False)
    ...
    op.create_index(op.f("ix_uptimelogs_id"), "uptimelogs", ["id"], unique=False)
    ...
    op.create_index(op.f("ix_apirequests_id"), "apirequests", ["id"], unique=False)
    ...
    op.create_index(
        op.f("ix_userinteractions_id"), "userinteractions", ["id"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(op.f("ix_userinteractions_id"), table_name="userinteractions")
