...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_foreign_key('logs_oauth_user_id_fkey', 'logs', 'oauthusers', ['oauth_user_id'], ['provider_user_id'])
    op.create_foreign_key('logs_apiKey_used_fkey', 'logs', 'apikey', ['apiKey_used'], ['apiKey'])
    # ### end Alembic commands ###
