...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('apikey', sa.Column('apiKey_used', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.create_foreign_key('apikey_apiKey_used_fkey', 'apikey', 'apikey', ['apiKey_used'], ['apiKey'])
    # ### end Alembic commands ###
