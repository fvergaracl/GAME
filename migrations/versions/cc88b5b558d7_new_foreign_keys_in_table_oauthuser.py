...
def upgrade():
    ...
    op.create_foreign_key(
        None, "apikey", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column("games", sa.Column("oauthusers_id", sa.String(), nullable=True))
    op.create_foreign_key(
        None, "games", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column("gamesparams", sa.Column("oauthusers_id", sa.String(), nullable=True))
    op.create_foreign_key(
        None, "gamesparams", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    ...
    op.create_foreign_key(
        None, "logs", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column("tasks", sa.Column("oauthusers_id", sa.String(), nullable=True))
    op.create_foreign_key(
        None, "tasks", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column("tasksparams", sa.Column("oauthusers_id", sa.String(), nullable=True))
    op.create_foreign_key(
        None, "tasksparams", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column("useractions", sa.Column("oauthusers_id", sa.String(), nullable=True))
    op.create_foreign_key(
        None, "useractions", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column("userpoints", sa.Column("oauthusers_id", sa.String(), nullable=True))
    op.create_foreign_key(
        None, "userpoints", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column("users", sa.Column("oauthusers_id", sa.String(), nullable=True))
    op.create_foreign_key(
        None, "users", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column("wallet", sa.Column("oauthusers_id", sa.String(), nullable=True))
    op.create_foreign_key(
        None, "wallet", "oauthusers", ["oauthusers_id"], ["provider_user_id"]
    )
    op.add_column(
        "wallettransactions", sa.Column("oauthusers_id", sa.String(), nullable=True)
    )
    op.create_foreign_key(
        None,
        "wallettransactions",
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "interactionDetail", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
        sa.Column("oauth_user_id", sa.VARCHAR(), autoincrement=False, nullable=True),
        sa.ForeignKeyConstraint(
            ["taskId"], ["tasks.id"], name="userinteractions_taskId_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["userId"], ["users.id"], name="userinteractions_userId_fkey"
        ),
