...
def upgrade():
    ...
    op.create_foreign_key(
        None, "apikey", "oauthusers", ["oauth_user_id"], ["provider_user_id"]
    )
    ...
    op.drop_constraint(
        "gamesparams_oauthusers_id_fkey", "gamesparams", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "tasksparams_oauthusers_id_fkey", "tasksparams", type_="foreignkey"
    )
    op.drop_column("tasksparams", "oauthusers_id")
    op.drop_constraint(
        "useractions_oauthusers_id_fkey", "useractions", type_="foreignkey"
    )
    op.drop_column("useractions", "oauthusers_id")
    op.drop_constraint(
        "userpoints_oauthusers_id_fkey", "userpoints", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "wallettransactions_oauthusers_id_fkey",
        "wallettransactions",
        type_="foreignkey",
    )
...
def downgrade():
    ...
    op.create_foreign_key(
        "useractions_oauthusers_id_fkey",
        "useractions",
        "oauthusers",
        ["oauthusers_id"],
        ["provider_user_id"],
    ...
    op.create_foreign_key(
        "tasksparams_oauthusers_id_fkey",
        "tasksparams",
        "oauthusers",
        ["oauthusers_id"],
        ["provider_user_id"],
    ...
    op.create_foreign_key(
        "gamesparams_oauthusers_id_fkey",
        "gamesparams",
        "oauthusers",
        ["oauthusers_id"],
        ["provider_user_id"],
